          ...
          <div className="bg-white rounded-3xl shadow-xl shadow-stone-200/50 p-8 md:p-12 border border-stone-100">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-[#1EBE5A] text-white py-4 rounded-xl text-lg font-bold hover:bg-[#128C7E] transition shadow-lg shadow-[#1EBE5A]/20 disabled:opacity-70 disabled:cursor-not-allowed mt-4 flex items-center justify-center gap-3"
              >
